...
#   login_session['state'] = state
#   return render_template('_page.html', title='Restaurants', view='login',
#     STATE=state)
...
def newRestaurant():
  if request.method == 'POST':
    ...
    # restaurant = Restaurant(name=request.form['name'].strip(), user_id='user_id')
...
def showMenu(restaurant_id):
  ...
  # return render_template('_page.html', title=restaurant.name, view='showMenu', restaurant=restaurant, items=items, owner=owner)
